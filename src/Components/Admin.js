                        ...
                        <tbody>
                            {
                                this.state.products.map(product=>
                                {
                                   return( <tr key={product.productId}>
                                        ...
                                        <td><button onClick={()=>this.editData(product.productId)} className="btn btn-primary">Update</button></td>
                                        {/* <button onClick={()=>this.deleteData(product.productId)} className="btn btn-danger">Delete</button> */}
                                    </tr>)
                                })
                            }
                        </tbody>
